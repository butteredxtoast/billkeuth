...
export default function Home() {
  return (
    <>
      ...
      <main className="min-h-screen p-8 md:p-24 max-w-6xl mx-auto font-[Quicksand] bg-background relative overflow-hidden">
        ...
        {/* Header Section */}
        <section className="mb-16 glass-card rounded-xl p-8 md:p-12 bg-white/80 shadow-lg border border-foreground/10">
        ...
        <section className="space-y-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {projects.map((project, index) => (
              <div key={index} className="project-card bg-white/90 rounded-lg shadow-lg overflow-hidden border border-foreground/10">
